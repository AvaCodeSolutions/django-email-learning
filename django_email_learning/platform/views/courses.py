...
class CourseView(BasePlatformView):
    ...
    def get_locale_messages(self) -> Dict[str, str]:
        return {
            ...
            "ai_edit_hint": _('Tip: select a paragraph above, then choose "Edit with AI" to have it rewritten.'),
            "ai_suggestion_label": _("AI suggestion"),
            "ai_suggestion_review_note": _("AI-generated text can be inaccurate — please review it before accepting."),
