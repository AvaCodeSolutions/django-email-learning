...
urlpatterns = [
    ...
    path(
        "organizations/<int:organization_id>/courses/<int:course_id>/tracks/<int:track_id>/",
        ContentTrackDetailView.as_view(),
        name="content_track_detail",
    ),
    path(
    ...
    path(
        ...
        OrganizationApiKeyView.as_view(),
        name="organization_api_keys_list",
    ),
    path(
        "organizations/<int:organization_id>/api-keys/<int:api_key_id>/",
        SingleOrganizationApiKeyView.as_view(),
        name="organization_api_keys_detail",
    ),
